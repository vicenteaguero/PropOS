...
class Template:
    ...
    language: str
    variables: tuple[str, ...]  # ordered names; map to {{1}},{{2}},...
    body: str  # source-of-truth body submitted to Meta
...
REGISTRY: dict[str, Template] = {
    "visit_confirmation": Template(
        ...
        body=(
            "Hola {{1}}, te confirmamos la visita a {{2}} el {{3}}. "
    ...
    "new_listing_match": Template(
        ...
        body=(
            "Hola {{1}}, encontramos una propiedad que coincide con tu búsqueda: "
            "{{2}}. Mirá los detalles: {{3}}"
        ),
    ),
    "proposal_accepted": Template(
        ...
        body=(
            "Hola {{1}}, tu propuesta fue aceptada: {{2}}. "
            "Coordinemos los próximos pasos."
        ),
    ),
}
