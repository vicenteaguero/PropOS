...
Punto de contacto de privacidad: **privacidad@propos.cl** (mientras se asignan los dominios definitivos `privacidad@ceterpropiedades.cl` y `privacidad@anaida.cl`).
...
PropOS contrata sub-encargados para procesar datos. Los principales son:
...
Las transferencias internacionales se amparan en Cláusulas Contractuales Tipo (SCC) publicadas por cada proveedor. La lista completa y actualizada está disponible en `docs/compliance/dpa-subprocessors.md`.
...
- **Oposición** — pedir que dejemos de usar tus datos para una finalidad específica (ej. marketing).
- **Portabilidad** — recibir tus datos en formato estructurado.
- **Bloqueo temporal** — suspender el tratamiento mientras resolvemos una disputa.
- **Oposición a decisiones automatizadas** — pedir intervención humana en decisiones que te afecten.

## 8. Cómo ejercer tus derechos

Escríbenos a **privacidad@propos.cl** desde el email con el que nos contactaste, indicando:

- Tu nombre, RUT y email registrado.
- Qué derecho ejerces.
- Descripción breve.

Te responderemos en un plazo máximo de **30 días corridos**, prorrogable por 30 días adicionales si la solicitud es compleja (te avisaremos).

## 9. Seguridad

Aplicamos medidas técnicas y organizativas razonables: cifrado en reposo (AES-256), TLS en tránsito, control de acceso por roles, registro de auditoría, copias de seguridad y aislamiento multi-tenant.

## 10. Notificación de brechas

En caso de incidente de seguridad que afecte tus datos, notificaremos a la Agencia de Protección de Datos Personales (APDP) dentro de las 72 horas y a ti directamente si existe riesgo significativo.
...
- Reclamos: **Agencia de Protección de Datos Personales (APDP)** — sitio oficial cuando esté operativa.
