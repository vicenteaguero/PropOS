...
import { LANDOWNER_NAV_ITEMS } from "@layouts/landowner/landowner-nav-items";
import { useAuth } from "@shared/hooks/use-auth";

export function LandownerLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-negro-carbon text-blanco-nieve">
      ...
      <BottomNav items={LANDOWNER_NAV_ITEMS} />
    </div>
  );
}
